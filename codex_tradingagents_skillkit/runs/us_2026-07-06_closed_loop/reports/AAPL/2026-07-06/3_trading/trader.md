...
Threshold result: BUY-capable score band. positive setup score lacks execution confirmation from trend, momentum, and support/resistance

## Setup Quality Assessment
Setup score +6: research alignment +2, trend +2, momentum +0, support/resistance +1, reward/risk +1, volatility/event risk +0, volume confirmation +0. Score band: BUY-capable score band.
...
Reference price: 308.63 using market:AAPL:2026-07-06:001 from source date 2026-07-02. Confirmation level: 313.00 using ATR and trend-level spacing (market:AAPL:2026-07-06:007). Invalidation / caution level: 293.46. This is a paper-study framework and not an entry order.
