...
|---|---|---|---:|---:|---|---|---|
| social:AAPL:2026-07-06:001 | fetch_stocktwits_messages | ticker_specific_retail_platform | 2 | 0 | 0/0/0 | low | no_usable_ticker_relevant_items |
| social:AAPL:2026-07-06:002 | fetch_reddit_posts | broad_social_discussion | 5 | 1 | 0/0/1 | low | none disclosed |
...
|---|---|---|---|---|
| social:AAPL:2026-07-06:item:0003 | fetch_reddit_posts | neutral | low | r/wallstreetbets — 1 recent posts mentioning AAPL (via RSS feed; scores/comments unavailable): |
